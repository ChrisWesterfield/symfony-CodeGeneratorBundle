...
use MjrOne\CodeGeneratorBundle\Traits\CodeGenerator\Tests\TraitRepositoryServiceTest;
 ...
 * @CG\Mutator(visibility="protected")
 * @CG\Entity()
 * @CG\Repository(em=false, serviceName="test.test.repository")
 * @ORM\Entity(repositoryClass="MjrOne\CodeGeneratorBundle\Tests\ServiceTest", readOnly=false);
 */
class ServiceTest
{
    use TraitRepositoryServiceTest;
