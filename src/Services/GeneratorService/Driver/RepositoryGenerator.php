...
class RepositoryGenerator extends GeneratorAbstract implements GeneratorInterface
{
    ...
    public function process()
    {
        ...
        /** @var CG\Repository\Repository $annotation */
        ...
        $output = $this->getRenderer()->renderTemplate('MjrOneCodeGeneratorBundle:Repository:base.php.twig',$templateVariables->toArray());
     ...
     * @todo add events
     */
    protected function checkServiceConfig($templateVariables, CG\Repository\Repository $annotation):void
    {
     ...
     * @return void
     */
    protected function checkEntityFile($templateVariables, CG\Repository\Repository $annotation):void
    {
